...
$stmt = $conn->prepare("SELECT email, phone_number, role FROM Users WHERE user_id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->bind_result($email, $phone_number, $role);
$stmt->fetch();
$stmt->close();
...
<body>
    <header>
        ...
        <a href="../Forms/Login/logout.php">Logout</a>
    </header>
