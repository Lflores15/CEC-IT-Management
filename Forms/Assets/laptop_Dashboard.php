...
<!-- Import Laptop Modal -->
<div id="importLaptopModal" class="laptop-modal-content-wrapper" style="display: none;">
  <div class="laptop-modal-content">
    <div class="laptop-modal-header">
    ...
    <button id="import-refresh-btn" style="display: none;">Refresh Page Now</button>
  </div>
</div>
...
<div id="auditLaptopModal" class="laptop-modal-content-wrapper" style="display: none;">
  <div class="laptop-modal-content">
    <div class="laptop-modal-header">
      <h2>Audit Laptops</h2>
      <span id="closeAuditLaptopModal" class="close">&times;</span>
    </div>

    <form id="auditForm">
      <p>Select an Active Employee CSV file to audit assigned laptops.</p>
      <input type="file" id="auditCsvFile" name="csv_file" accept=".csv" required>
      <div id="audit-result-message" style="display:none;"></div>
      <button type="submit" id="runAuditBtn">Run Audit</button>
    </form>
  </div>
</div>
    ...
    <div style="flex: 1 1 50%; min-width: 300px;">
      ...
      <div id="log-history-container" class="log-table-scrollable" style="overflow-y: auto;">
        <table class="device-table" style="font-size: 0.85em;">
          ...
          <tbody id="device-log-history"></tbody>
        </table>
      </div>
    </div>
  </div>
